<%-- 
    Document   : add_employees
    Created on : Jul 23, 2018, 3:47:38 PM
    Author     : Acer_Aspire
--%>
                                        ...
                                        <div class="card-body card-block">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <input type="text" id="text-input" name="MaNV" placeholder="Mã nhân viên" class="form-control" required="">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <input type="text" id="text-input" name="username" placeholder="Tên đăng nhập..." class="form-control" required="">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <input type="password" id="hf-password" name="pass" placeholder="Mật khẩu..." class="form-control" required="">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <input type="text" id="text-input" name="HoTen" placeholder="Họ và tên..." class="form-control" required="">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <input type="text" id="text-input" name="SDT" placeholder="Số điện thoại..." class="form-control" required="">
