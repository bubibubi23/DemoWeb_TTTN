<%-- 
    ...
    Created on : Jul 24, 2018, 10:19:48 AM
    Author     : Acer_Aspire
--%>
                                        ...
                                        <div class="card-body card-block">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <input type="text" id="text-input" name="MaSP" placeholder="Mã sản phẩm..." class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <input type="text" id="text-input" name="TenSP" placeholder="Tên sản phẩm..." class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <input type="number" id="hf-email" name="Gia" placeholder="Giá tiền..." class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-6">
                                                    <input type="text" id="text-input" name="MoTa" placeholder="Mô tả..." class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea name="ThongSoSP" id="textarea-input" rows="9" placeholder="Nội dung..." class="form-control"></textarea>
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
