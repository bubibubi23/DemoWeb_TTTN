<%-- 
    Document   : update_shippers
    Created on : Jul 24, 2018, 9:43:08 AM
    Author     : Acer_Aspire
--%>
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <strong>CẬP NHẬT NHÂN VIÊN GIAO HÀNG</strong>
                                        </div>
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <input type="hidden" name="MaNVGiaoHang" value="<%=request.getParameter("MaNVGiaoHang") %>"/>
