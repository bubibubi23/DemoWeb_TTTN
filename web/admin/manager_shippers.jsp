<%-- 
    Document   : manager_shippers
    Created on : Jul 19, 2018, 9:06:14 PM
    Author     : Acer_Aspire
--%>
<%@page import="Model.NhanVienGiaoHang"%>
<%@page import="DAO.NhanVienGiaoHangDAO"%>
...
<html>
    ...
    <body class="animsition">
        <%
            NhanVienGiaoHangDAO nhanvienghDAO = new NhanVienGiaoHangDAO();
        %>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="user-data m-b-30">
                                            <h3 class="title-3 m-b-30">
                                                <i class="zmdi zmdi-account-calendar"></i>Thông tin nhân viên giao hàng</h3>
                                            <div class="filters m-b-45">
                                                ...
                                                <a href="${root}/admin/add_shippers.jsp"><button class="au-btn au-btn-icon au-btn--green au-btn--small">
                                            ...
                                            <div class="table-responsive table-data">
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        <%for(NhanVienGiaoHang nhanviengh : nhanvienghDAO.listNhanVienGiaoHangHoatDong()) { %>
                                                        <tr>                                                   
                                                            <td>
                                                                <div class="table-data__info">                                                           
                                                                    <h6><%=nhanviengh.getMaNVGiaoHang() %></h6>                                                                                          
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="table-data__info">
                                                                    <h6><%=nhanviengh.getHoTen() %></h6>                                               
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="table-data__info">
                                                                    <h6><%=nhanviengh.getSDT() %></h6>                                               
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="table-data__info">
                                                                    <h6><%=nhanviengh.getEmail() %></h6>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="table-data__info">
                                                                    <h6><%=nhanviengh.getDiaChi() %></h6>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <a href="${root}/admin/update_shippers.jsp?command=update&MaNVGiaoHang=<%=nhanviengh.getMaNVGiaoHang() %>"> <button class="item" data-toggle="tooltip" data-placement="top" title="Sửa">
                                                                    <i class="zmdi zmdi-edit"></i>
                                                                    </button></a>
                                                            </td>
                                                            <td>
                                                                <a href="${root}/QuanLyNhanVienGiaoHangServlet?command=delete&MaNVGiaoHang=<%=nhanviengh.getMaNVGiaoHang() %>"><button class="item" data-toggle="tooltip" data-placement="top" title="Xóa">
